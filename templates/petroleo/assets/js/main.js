...
class RadioPulse {
  ...
  setupAudioPlayer() {
    console.log('RadioPulsePlayer: Setting up audio player...');
    ...
    setTimeout(() => {
      ...
      console.log('RadioPulsePlayer: Audio elements found:', {
      ...
      if (fixedPlayer) {
        ...
        fixedPlayer.style.transform = 'translateY(0)';
        fixedPlayer.style.pointerEvents = 'auto';
        fixedPlayer.classList.remove('collapsed');
        console.log('RadioPulsePlayer: Fixed player visibility forced');
      }
      ...
      if (playBtn) {
        ...
        newPlayBtn.addEventListener('click', (e) => {
          e.preventDefault();
          e.stopPropagation();
          console.log('RadioPulsePlayer: Play button clicked!');
          this.toggleAudio();
        });
        ...
        newPlayBtn.addEventListener('touchend', (e) => {
          e.preventDefault();
          e.stopPropagation();
          console.log('RadioPulsePlayer: Play button touched!');
          this.toggleAudio();
        });
        
        console.log('RadioPulsePlayer: Play button event listeners added');
      }
      ...
      if (playerToggle) {
        ...
        newPlayerToggle.addEventListener('click', (e) => {
          e.preventDefault();
          e.stopPropagation();
          console.log('RadioPulsePlayer: Player toggle clicked!');
          this.togglePlayer();
        });
        
        console.log('RadioPulsePlayer: Player toggle event listeners added');
      }
      ...
      console.log('RadioPulsePlayer: Audio player setup completed');
    }, 500);
  }
  ...
  async initializeTVPlayer() {
    ...
    try {
      ...
      setTimeout(async () => {
        const video = document.getElementById('tv-video-petroleo');
